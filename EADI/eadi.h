...
double			sr = 34.0/255.0,		sg = 124.0/255.0,	sb = 177.0/255.0;
double			gr = 129.0/255.0,		gg = 105.0/255.0,	gb = 59.0/255.0;
...
double			stleft = -45.0;    // Speed tape dimensions.
double			stright = -33.0;    // Speed tape dimensions.
double			stbottom = -35.0;    // Speed tape dimensions.
double			sttop = 35.0;    // Speed tape dimensions.
double			atleft = 25.0;    // Alt tape dimensions
double			atright = 37.0;    // Alt tape dimensions    SUBTRACT 2 FOR THE AIRBUS
